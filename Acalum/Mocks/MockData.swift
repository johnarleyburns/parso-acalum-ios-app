...
enum MockData {
    static let pills: [Pill] = [
        Pill(id: "instrument:guitar", label: "Guitar", category: .instrument),
        Pill(id: "instrument:piano", label: "Piano", category: .instrument),
        Pill(id: "instrument:violin", label: "Violin", category: .instrument),
        Pill(id: "instrument:choir", label: "Choir", category: .instrument),
        Pill(id: "instrument:organ", label: "Organ", category: .instrument),
        Pill(id: "instrument:orchestra", label: "Orchestra", category: .instrument),
        Pill(id: "mood:calm", label: "Calm", category: .mood),
        Pill(id: "mood:melancholy", label: "Melancholy", category: .mood),
        Pill(id: "mood:joyful", label: "Joyful", category: .mood),
        Pill(id: "mood:sacred", label: "Sacred", category: .mood),
        Pill(id: "mood:romantic", label: "Romantic", category: .mood),
        Pill(id: "mood:nostalgic", label: "Nostalgic", category: .mood),
        Pill(id: "context:reading", label: "Reading", category: .context),
        Pill(id: "context:sleep", label: "Sleep", category: .context),
        Pill(id: "context:focus", label: "Focus", category: .context),
        Pill(id: "context:rainy_day", label: "Rainy Day", category: .context),
        Pill(id: "context:late_night", label: "Late Night", category: .context),
        Pill(id: "era:baroque", label: "Baroque", category: .era),
        Pill(id: "era:romantic", label: "Romantic Era", category: .era),
        Pill(id: "era:medieval", label: "Medieval", category: .era),
        Pill(id: "era:jazz_age", label: "Jazz Age", category: .era),
        Pill(id: "era:early_1900s", label: "Early 1900s", category: .era),
    ]
